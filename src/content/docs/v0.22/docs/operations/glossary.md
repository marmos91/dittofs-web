...
editUrl: https://github.com/marmos91/dittofs/edit/v0.22.0/docs/guide/glossary.md
sidebar:
  order: 8
slug: v0.22/docs/operations/glossary
---
...
also live in [NFS.md](/v0.22/docs/connect/nfs#glossary) and [SMB.md](/v0.22/docs/connect/smb#glossary).
...
| Term | Definition |
|------|------------|
| **ACL** (Access Control List) | The ordered list of rules that decides who may do what to a file. DittoFS uses one cross-protocol ACL model for both NFS and SMB. See [ACLS.md](/v0.22/docs/connect/access-control). |
...
| Term | Definition |
|------|------------|
| **Kerberos** | A ticket-based network authentication protocol. DittoFS supports it for both NFS (via RPCSEC\_GSS) and SMB (via SPNEGO). [RFC 4120](https://www.rfc-editor.org/rfc/rfc4120) |
...
| **RPCSEC\_GSS** | The NFS/RPC security flavor that carries GSS-API (Kerberos) authentication and optional integrity/privacy. [RFC 2203](https://www.rfc-editor.org/rfc/rfc2203) |
| **AUTH\_UNIX** | The basic NFS authentication flavor that simply asserts a UID/GID — trusted only on a trusted network. |
...
* [NFS.md](/v0.22/docs/connect/nfs#glossary) — NFS-specific terms (XID, verifier, COMPOUND, FSID, …)
* [SMB.md](/v0.22/docs/connect/smb#glossary) — SMB-specific terms (dialect, credit, transform header, KDF, …)
* [ACLS.md](/v0.22/docs/connect/access-control) — the cross-protocol ACL model in depth
* [ENCRYPTION.md](/v0.22/docs/operations/encryption) — at-rest encryption (master key / block key)
