...
editUrl: https://github.com/marmos91/dittofs/edit/v0.22.0/docs/guide/block-store-migration.md
sidebar:
  order: 5
slug: v0.22/docs/operations/block-store-migration
---
...
see [ARCHITECTURE.md](/v0.22/docs/contributing/architecture#migration--block-layout-routing).
...
* **Atomic per-share snapshots** (reference holds; see [SNAPSHOTS.md](/v0.22/docs/operations/snapshots)).
