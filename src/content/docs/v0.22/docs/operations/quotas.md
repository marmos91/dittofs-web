...
editUrl: https://github.com/marmos91/dittofs/edit/v0.22.0/docs/guide/quotas.md
sidebar:
  order: 2
slug: v0.22/docs/operations/quotas
---
...
> [Configuration § Shares](/v0.22/docs/getting-started/configuration#8-shares-exports).
