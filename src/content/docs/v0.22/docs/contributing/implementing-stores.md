...
editUrl: https://github.com/marmos91/dittofs/edit/v0.22.0/docs/internals/implementing-stores.md
sidebar:
  order: 7
slug: v0.22/docs/contributing/implementing-stores
---
...
* [ARCHITECTURE.md — Migration & Block-Layout Routing](/v0.22/docs/contributing/architecture#migration--block-layout-routing)
  for how the engine consumes the flag.
* [BLOCKSTORE\_MIGRATION.md](/v0.22/docs/operations/block-store-migration)
