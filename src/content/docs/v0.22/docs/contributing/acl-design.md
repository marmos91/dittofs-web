...
editUrl: https://github.com/marmos91/dittofs/edit/v0.22.0/docs/internals/acl-design.md
sidebar:
  order: 4
slug: v0.22/docs/contributing/acl-design
---

> This document is for contributors. For user/operator guidance on setting ACLs and cross-protocol scenarios, see [../guide/access-control.md](/v0.22/docs/connect/access-control).
...
|---------|-------------------|--------------------|-------|
| ACE types | ALLOW, DENY, AUDIT, ALARM | ACCESS\_ALLOWED, ACCESS\_DENIED, SYSTEM\_AUDIT, SYSTEM\_ALARM | Identical values |
| Access mask bits | 16 permission bits (READ\_DATA=0x01, WRITE\_DATA=0x02, ...) | Same 16 bits (FILE\_READ\_DATA=0x01, FILE\_WRITE\_DATA=0x02, ...) | Identical values |
| Inheritance flags | FILE\_INHERIT, DIRECTORY\_INHERIT, NO\_PROPAGATE, INHERIT\_ONLY | OBJECT\_INHERIT, CONTAINER\_INHERIT, NO\_PROPAGATE, INHERIT\_ONLY | Identical semantics |
...
* **FATTR4\_ACLSUPPORT**: Reports support for all 4 ACE types (ALLOW, DENY, AUDIT, ALARM)
...
### Building a Security Descriptor (QUERY\_INFO)
...
### Parsing a Security Descriptor (SET\_INFO)
