...
See [CLI.md](/docs/getting-started/cli#dfsctl-trash) for the `dfsctl trash`
...
See the [SMB security model](/docs/operations/security#smb-encryption) for protocol-level
