...
sidebar:
  order: 1
# Synced from dittofs/docs/SECURITY.md — do not edit here.
---
...
See [docs/SMB.md](/docs/protocols/smb) for complete wire format details and configuration examples.
...
See [docs/CONFIGURATION.md](/docs/operations/configuration) for complete SMB3 adapter configuration options.
