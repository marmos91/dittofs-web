...
sidebar:
  order: 2
# Synced from dittofs/docs/SMB.md — do not edit here.
---
...
See [docs/CONFIGURATION.md](/docs/operations/configuration) for complete encryption configuration options.
See [docs/SECURITY.md](/docs/security/security) for security implications and recommendations.
...
See [docs/SECURITY.md](/docs/security/security) for detailed Kerberos security considerations.
...
See [docs/TROUBLESHOOTING.md](/docs/operations/troubleshooting) for cross-protocol troubleshooting, including:
...
For plain-language definitions of these terms, see the project-wide [Glossary](https://github.com/marmos91/dittofs/blob/develop/docs/GLOSSARY.md).
