...
editUrl: "https://github.com/marmos91/dittofs/edit/develop/docs/product/pro.md"
sidebar:
  order: 1
# Synced from dittofs/docs/product/pro.md — do not edit here.
---
...
![DittoFS Pro dashboard](/docs-assets/pro/dashboard.png)
