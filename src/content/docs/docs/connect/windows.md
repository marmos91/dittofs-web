...
editUrl: "https://github.com/marmos91/dittofs/edit/develop/docs/guide/windows.md"
sidebar:
  order: 3
# Synced from dittofs/docs/guide/windows.md — do not edit here.
---
...
[`../internals/testing.md`](/docs/contributing/testing).
...
(`FSCTL_SRV_COPYCHUNK`) **are** supported — see [`./smb.md`](/docs/connect/smb).
...
| `Set-Acl` returns an error | Best-effort ACL mapping | DittoFS translates SMB SET_INFO ACL changes to Unix mode bits; complex ACLs may not map cleanly |
