...
editUrl: "https://github.com/marmos91/dittofs/edit/develop/docs/internals/encryption-design.md"
sidebar:
  order: 6
# Synced from dittofs/docs/internals/encryption-design.md — do not edit here.
---

> This document is for contributors. For user/operator guidance on enabling encryption, configuration, and operational warnings, see [../guide/encryption.md](/docs/operations/encryption).
